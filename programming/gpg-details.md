---
title: GPG Internal Details
description: 
published: 1
date: 2025-03-15T14:03:53.451Z
tags: 
editor: markdown
dateCreated: 2025-03-15T14:03:53.451Z
---
...
*** REVKEYSIG  <long_keyid_or_fpr>  <username>
    ...
    eventually also beÃ± available for OpenPGP.
...
*** TOFU_STATS <MANY_ARGS>
    ...
    SUMMARY values use the euclidean distance (m = sqrt(aÂ² + bÂ²)) rather
    ...
    - 2 :: 1 <= sqrt(signature_daysÂ² + encryption_daysÂ²) < 8
    - 3 :: 8 <= sqrt(signature_daysÂ² + encryption_daysÂ²) < 42
    - 4 :: sqrt(signature_daysÂ² + encryption_daysÂ²) >= 42
